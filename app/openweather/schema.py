...
class Temp(BaseModel):
    ...
    min: Optional[float] = Field(
        None, description="Min daily temperature.", example=-0.5
    )
    max: Optional[float] = Field(
        None, description="Max daily temperature.", example=10.4
    )
...
class Rain(BaseModel):
    ...
    h: Optional[float] = Field(
        None,
        description="(where available) Precipitation, mm/h. Please note that only mm/h as "
...
class Current(BaseModel):
    dt: Optional[int] = Field(
        None, description="Time of the forecasted data, unix, UTC", example=1704651747
    )
    sunrise: Optional[int] = Field(
        None,
        description="Sunrise time, Unix, UTC. For polar areas in midnight sun and "
    ...
    sunset: Optional[int] = Field(
        None,
        description="Sunset time, Unix, UTC. For polar areas in midnight sun and polar "
        "night periods this parameter is not returned in the response",
        example=1704727422,
    )
    temp: Optional[float] = Field(
        None,
        description="Units – default: kelvin, metric: Celsius, imperial: Fahrenheit.",
        example=8.4,
    )
    feels_like: Optional[float] = Field(
        None,
        description="This accounts for the human perception of weather. Units – "
        "default: kelvin, metric: Celsius, imperial: Fahrenheit.",
        example=5.9,
    )
    pressure: Optional[int] = Field(
        None, description="Atmospheric pressure on the sea level, hPa", example=1030
    )
    humidity: Optional[int] = Field(None, description="Humidity, %", example=58)
    dew_point: Optional[float] = Field(
        None,
        description="Atmospheric temperature (varying according to pressure and "
    ...
    uvi: Optional[float] = Field(
        None, description="The maximum value of UV index for the day", example=0.51
    )
    visibility: Optional[int] = Field(
        None,
        description="Average visibility, metres. The maximum value of the "
        "visibility is 10 km",
        example=10000,
    )
    wind_speed: Optional[float] = Field(
        None,
        description="Wind speed. Units – default: metre/sec, metric: metre/sec, "
        "imperial: miles/hour.",
        example=5.33,
    )
    wind_gust: Optional[float] = Field(
        None,
        description="(where available) Wind gust. Units – default: metre/sec, "
        "metric: metre/sec, imperial: miles/hour.",
        example=14.1,
    )
    wind_deg: Optional[int] = Field(
        None, description="Wind direction, degrees (meteorological)", example=71
    )
    rain: Optional[Rain] = Field(
        None,
        description="(where available) Precipitation volume, mm. Please note that only "
        "mm as units of measurement are available for this parameter",
        example=12.6,
    )
    snow: Optional[Snow] = Field(
        None,
        description="(where available) Snow volume, mm. Please note that only mm as "
        "units of measurement are available for this parameter",
        example=4.5,
    )
    weather: Optional[List[WeatherData]] = Field(
        None, description="Weather Condition and icon"
    )
...
class Minutely(BaseModel):
    ...
    precipitation: Optional[float] = Field(
        None,
        description="Precipitation, mm/h. Please note that only mm/h as units "
...
class Hourly(BaseModel):
    ...
    pop: Optional[float] = Field(
        None,
        description="Probability of precipitation. The values of the parameter "
...
class Daily(BaseModel):
    ...
    moon_phase: Optional[float] = Field(
        None,
        description="Moon phase. 0 and 1 are 'new moon', 0.25 is 'first quarter "
    ...
    temp: Optional[Temp] = Field(
        None,
        description="Units – default: kelvin, metric: Celsius, imperial: Fahrenheit.",
    )
    feels_like: Optional[FeelsLike] = Field(
        None,
        description="This accounts for the human perception of weather. "
    ...
    pop: Optional[float] = Field(
        None,
        description="Probability of precipitation. The values of the parameter vary "
...
class Alerts(BaseModel):
    sender_name: Optional[str] = Field(
        None, description="Name of the alert source", example="Deutscher Wetterdienst"
    )
    event: Optional[str] = Field(
        None, description="Alert event name", example="icy surfaces"
    )
    ...
    tags: Optional[List[str]] = Field(
        None, description="Type of severe weather", example=["Other dangers"]
    )


class OpenweatherData(BaseModel):
    lat: Optional[float] = Field(
        None, description=" Latitude of the location, decimal (−90; 90)", example=-16.92
    )
    lon: Optional[float] = Field(
        None, description="Longitude of the location, decimal", example=145.77
    )
    ...
    timezone_offset: Optional[int] = Field(
        None, description="Shift in seconds from UTC", example=3600
    )

    current: Optional[Current] = Field(
        None, description="Current weather data API response"
    )

    minutely: Optional[List[Minutely]] = Field(
        None, description="Minute forecast weather data API response"
    )

    hourly: Optional[List[Hourly]] = Field(
        None, description="Hourly forecast weather data API response"
    )

    daily: Optional[List[Daily]] = Field(
        None, description="Daily forecast weather data API response"
    )

    alerts: Optional[List[Alerts]] = Field(
        None,
        description="National weather alerts data from major national weather "
        "warning systems",
    )
